...
with st.sidebar:
    ...
    check_sr = st.checkbox(
        "Shared room", value=True, label_visibility="hidden"
    ), st.write("Pokój współdzielony")
    check_pr = st.checkbox("Private room", value=True)
    check_ent = st.checkbox("Entire home/apt", value=True)
